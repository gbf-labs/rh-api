...
class NetworkPerformance(Common):
    """Class for NetworkPerformance"""

    # INITIALIZE
    def __init__(self):
        """The Constructor for NetworkPerformance class"""
        self._couch_db = CouchDatabase()
        self.postgresql_query = PostgreSQL()
        self.couch_query = Queries()
        self.epoch_default = 26763
        super(NetworkPerformance, self).__init__()

    def network_performance(self):

        """
        This API is for Getting Network Performance
        ---
        tags:
          - Vessel
        produces:
        ...
        if values:
            ...
            temp_datas, options, categories = self.values_wrapper("NTWPERF1",
                                                                  all_values,
                                                                  timestamp
                                                                 )
