...
class CoreValues(Common):
    """Class for CoreValues"""

    # INITIALIZE
    def __init__(self):
        """The Constructor for CoreValues class"""
        self._couch_db = CouchDatabase()
        self.postgresql_query = PostgreSQL()
        self.couch_query = Queries()
        self.epoch_default = 26763
        super(CoreValues, self).__init__()

    def core_values(self):

        """
        This API is for Getting Core Values
        ---
        tags:
          - Vessel
        produces:
        ...
        if values:
            ...
            temp_datas, options, categories = self.values_wrapper("COREVALUES",
                                                                  all_values,
                                                                  timestamp
                                                                 )
        ...
        datas = convert.check_unit(datas, exempt="uptime")
